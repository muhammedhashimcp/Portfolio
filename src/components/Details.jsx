...
const Details = () => {
	return (
		<div
			name="work"
			className="w-full md:h-screen text-gray-300 bg-[#0a192f] md:px-5 pt-20 pb-10 "
		>
				...
				<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
					...
					{array.map((arr) => (
						...
						>
							...
							<h2 className="absolute opacity-100 group-hover:opacity-0 text-2xl text-bold text-pink-600 bottom-4 ">
								Bottom Center{' '}
							</h2>
							{/* Hover effects */}
